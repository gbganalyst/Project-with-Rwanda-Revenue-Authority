...
setwd('//192.168.0.17/planning/STATISTICS DIVISION/Performance Analysis/FY 2018-19/WOP 15%')
...
# Reading (Withholding tax) data from the server

WOP_JULY_sEP_2018 <- readxl::read_xlsx( "wop 15% jULY-sEP 2018 PAYMENTS.xlsx")
WOP_JULY_sEP_2017 <- readxl::read_xlsx( "wop 15% jULY-sEP 2017 PAYMENTS.xlsx")

# Choosing columns that are needed for the analysis

WOP_JULY_sEP_2018_1= WOP_JULY_sEP_2018%>% select(2,3,7) 
WOP_JULY_sEP_2017_1= WOP_JULY_sEP_2017%>% select(2,3,8) 
...
write.xlsx(data_combined,"WOP 15% comparison july-Sep 2018-19 Vs 17-18.xlsx")
